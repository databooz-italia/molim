...
namespace Molim.Backend.API.Migrations
{
    ...
    [Migration("20210820103336_RichiesteEsecuzione_IntegrazioneServiziEsterni")]
    partial class RichiesteEsecuzione_IntegrazioneServiziEsterni
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Molim.Backend.API.BusinessLayer.Data.Entities.Algoritmo", b =>
                {
                    ...
                    b.Property<string>("OggettoDiPredizione")
                        .IsRequired()
            ...
            modelBuilder.Entity("Molim.Backend.API.BusinessLayer.Data.Entities.Diagnosi", b =>
                {
                    ...
                    b.HasKey("IdPaziente", "IdPatologia", "Date");
            ...
            modelBuilder.Entity("Molim.Backend.API.BusinessLayer.Data.Entities.EsecutoreRichiesta", b =>
                {
            ...
            modelBuilder.Entity("Molim.Backend.API.BusinessLayer.Data.Entities.Predizione", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Molim.Backend.API.BusinessLayer.Data.Entities.RichiestaEsecuzione", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdEsecutore");

                    b.HasIndex("IdPaziente");

                    b.HasIndex("IdTipoEsame", "IdPatologia");

                    b.ToTable("richiesteesecuzione");
                });

            modelBuilder.Entity("Molim.Backend.API.BusinessLayer.Data.Entities.RichiestaEsecuzioneFase", b =>
                {
                    b.Property<int>("IdRichiestaEsecuzione")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("DataUltimaEsecuzione")
                        .HasColumnType("datetime");
                    ...
                    b.HasKey("IdRichiestaEsecuzione", "IdFase", "Ordine");

                    b.ToTable("richiestaesecuzionefasi");
                });

            modelBuilder.Entity("Molim.Backend.API.BusinessLayer.Data.Entities.ScorePredizione", b =>
                {
                    b.Property<string>("Descrizione")
                        .HasColumnType("varchar(200)")
                        .HasMaxLength(200);

                    b.Property<int>("IdPredizione")
                        .HasColumnType("int");
                    ...
                    b.HasKey("Descrizione", "IdPredizione")
                        .HasName("PRIMARY");

                    b.HasIndex("IdPredizione")
                        .HasName("fk_score_predizioni_diagnosi1_idx");

                    b.ToTable("score_predizioni");
                });
            ...
            modelBuilder.Entity("Molim.Backend.API.BusinessLayer.Data.Entities.RichiestaEsecuzione", b =>
                {
                    b.HasOne("Molim.Backend.API.BusinessLayer.Data.Entities.Algoritmo", "Algoritmo")
                        .WithMany("RichiesteEsecuzione")
                        .HasForeignKey("IdAlgoritmo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Molim.Backend.API.BusinessLayer.Data.Entities.EsecutoreRichiesta", "Esecutore")
                        .WithMany("RichiesteEsecuzione")
                        .HasForeignKey("IdEsecutore")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Molim.Backend.API.BusinessLayer.Data.Entities.RichiestaEsecuzioneFase", b =>
                {
                    b.HasOne("Molim.Backend.API.BusinessLayer.Data.Entities.RichiestaEsecuzione", "Richiesta")
                        .WithMany("Fasi")
                        .HasForeignKey("IdRichiestaEsecuzione")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Molim.Backend.API.BusinessLayer.Data.Entities.ScorePredizione", b =>
                {
                    b.HasOne("Molim.Backend.API.BusinessLayer.Data.Entities.Predizione", "Predizione")
                        .WithMany("ScoreDiagnosi")
                        .HasForeignKey("IdPredizione")
